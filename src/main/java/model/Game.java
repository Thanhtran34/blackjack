...
public class Game {
  ...
  public Game(model.rules.Game g) {
    dealer = new Dealer(g);
    player = new Player();
  }
  ...
  /** Method to set observer for player and dealer. */
  public void setGameObserver(Observer observer) {
    this.dealer.setObserver(observer);
